...
<p align="center">
  <a href="https://labex.io/pt/courses/lateral-movement-pivoting">
    <img src="https://course-cover.labex.io/lateral-movement-pivoting.png?lang=pt" alt="Movimentação Lateral e Pivoting">
  </a>
</p>
...
[Iniciar curso no LabEx](https://labex.io/pt/courses/lateral-movement-pivoting)

## Exercícios

|   Índice | Nome                                             | Dificuldade   | Prática                                                                                                                                                   |
|----------|--------------------------------------------------|---------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------|
|        1 | Tunelamento SSH e Encaminhamento de Portas       | Iniciante     | <a target='_blank' href='https://labex.io/pt/labs/linux-ssh-tunneling-port-forwarding-656179?course=lateral-movement-pivoting'>Iniciar Lab</a>            |
|        2 | Encaminhamento de Porta Dinâmico com Proxychains | Iniciante     | <a target='_blank' href='https://labex.io/pt/labs/linux-dynamic-port-forwarding-with-proxychains-656177?course=lateral-movement-pivoting'>Iniciar Lab</a> |
|        3 | Autorouting no Metasploit                        | Iniciante     | <a target='_blank' href='https://labex.io/pt/labs/linux-metasploit-autorouting-656178?course=lateral-movement-pivoting'>Iniciar Lab</a>                   |
|        4 | Desafio de Invasão de Rede Interna               | Intermediário | <a target='_blank' href='https://labex.io/pt/labs/linux-internal-network-breach-challenge-656176?course=lateral-movement-pivoting'>Iniciar Desafio</a>    |
