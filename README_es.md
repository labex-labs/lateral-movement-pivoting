...
<p align="center">
  <a href="https://labex.io/es/courses/lateral-movement-pivoting">
    <img src="https://course-cover.labex.io/lateral-movement-pivoting.png?lang=es" alt="Movimiento Lateral y Pivoting">
  </a>
</p>
...
[Iniciar curso en LabEx](https://labex.io/es/courses/lateral-movement-pivoting)

## Ejercicios

|   Índice | Nombre                                      | Dificultad   | Práctica                                                                                                                                                  |
|----------|---------------------------------------------|--------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------|
|        1 | Túneles SSH y reenvío de puertos            | Principiante | <a target='_blank' href='https://labex.io/es/labs/linux-ssh-tunneling-port-forwarding-656179?course=lateral-movement-pivoting'>Iniciar lab</a>            |
|        2 | Reenvío dinámico de puertos con Proxychains | Principiante | <a target='_blank' href='https://labex.io/es/labs/linux-dynamic-port-forwarding-with-proxychains-656177?course=lateral-movement-pivoting'>Iniciar lab</a> |
|        3 | Autorouting en Metasploit                   | Principiante | <a target='_blank' href='https://labex.io/es/labs/linux-metasploit-autorouting-656178?course=lateral-movement-pivoting'>Iniciar lab</a>                   |
|        4 | Desafío de Intrusión en Red Interna         | Intermedio   | <a target='_blank' href='https://labex.io/es/labs/linux-internal-network-breach-challenge-656176?course=lateral-movement-pivoting'>Iniciar desafío</a>    |
